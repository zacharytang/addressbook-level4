...
UniFy is a command-line application which provides a way to store students' contact information.
It provides powerful functions and user-friendly interface for NUS students, and it allows them to efficiently manage their contact lists.
This developer guide provides a brief introduction to the basic information about this application, helping you get started with the contribution work.
