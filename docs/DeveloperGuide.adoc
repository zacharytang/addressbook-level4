...
_Figure 4.5.1 : High-level Sequence Diagram_
...
_Figure 4.5.2 : Logic Component Class Diagram_
...
As shown in Figure 4.5.3, the `AddressBook` consists of one `UniqueTagList`, one `UniquePersonList`, and one `UniquePhotoPathList`.
...
_Figure 4.5.3 : Model Component Class Diagram_
...
_Figure 4.6.1 : UML diagram for updated Model with Birthday_
