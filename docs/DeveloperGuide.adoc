...
|`* * *` |user |edit a person in the address book| correct any outdated information

|`* * *` |user |delete a person |remove entries that I no longer need

|`* * *` |user |clear the entire address book |remove all entries without tedious single deletions

|`* * *` |user |see a history of my commands |retrieve a command to execute again or see my past actions

|`* * *` |user |list all the people in the address book  |see all the contacts I have

|`* * *` |user |select a person from a list by it's index  |easily select a person from a list I have just seen
...
|`* * *` |user with many persons in the address book |sort my contacts by name |locate a contact easily
