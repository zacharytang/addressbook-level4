...
.A person with various contact information +
...
=== Adding/Deleting a Photo for a person : `photo` _(Coming in v2.0)_
____
...
* The list will be ordered in terms of ascending order of their birthday dates.
