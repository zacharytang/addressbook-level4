...
Format: `add n/NAME m/MATRIC_NUMBER g/GENDER p/PHONE_NUMBER e/EMAIL a/ADDRESS [t/TAG] [tt/NUM_OF_MONTHS/TEMPORARY TAG]...` +
...
the temporary tag will disappear on its own after the certain number of months.


Examples:

* `add n/John Doe m/A0134232H g/Male p/98765432 e/johnd@example.com a/John street, block 123, #01-01`
* `add n/Betsy Crowe t/friend g/Female e/betsycrowe@example.com a/Newgate Prison p/1234567 t/criminal`
* `add n/Amy Tan m/A0142323T tt/4/CS2101classmates e/amy_tan@example.com a/PGP p/82974823`
...
Deletes the multiple specified persons from the address book. +
Format: `delete [INDEX1], [INDEX2], [INDEX3]...` +
Alternatives: `d` , `remove`

Deletes the contacts which you haven't used the 'edit', 'photo' or 'find' command for K months. +
Format: `delete old/K` +
Alternatives: `d` , `remove`

****
* Deletes the person at the specified `INDEX`.
* The INDEX1, INDEX2, INDEX3... refer to the index numbers shown in the most recent listing.
* The index *must be a positive integer* 1, 2, 3, ...
* The K *must be a positive integer* 1, 2, 3, ...
****
