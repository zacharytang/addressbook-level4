...
Format: `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS [t/TAG] [tt/NUM_OF_MONTHS/TEMPORARY TAG]...` +
...
* `add n/Amy Tan tt/4/CS2101classmates e/amy_tan@example.com a/PGP p/82974823`
