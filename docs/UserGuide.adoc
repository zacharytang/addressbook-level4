...
* `add n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01 b/19980523`
...
=== Command Suggestion
Typeing the wrong word for a command will trigger the address book to suggest the correct phrasing for that command
