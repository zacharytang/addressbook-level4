...
/**
 * Represents a zero-based or one-based targetIndex.
 *
 ...
 * base the other component is using for its targetIndex. However, after receiving the {@code Index}, that component can
 * convert it back to an int if the targetIndex will not be passed to a different component again.
 */
public class Index {
    ...
    /**
     * Creates a new {@code Index} using a zero-based targetIndex.
     */
    ...
    /**
     * Creates a new {@code Index} using a one-based targetIndex.
     */
